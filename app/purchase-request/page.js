...
>
  ...
  >
    ...
    >
      ...
      <option>Requester 1</option>
      <option>Requester 2</option>
      <option>Requester 3</option>
    </select>
  </div>
        ...
        <Table component={Paper} className="shadow-sm shadow-slate-800 px-12">
          <TableHead>
            <TableRow>
              ...
              <TableCell className="text-sm font-bold">Vendor</TableCell>
              <TableCell className="text-sm font-bold">Required Date</TableCell>
              <TableCell className="text-sm font-bold">Required Qty.</TableCell>
              <TableCell className="text-sm font-bold">Info Price</TableCell>
